...
describe(
  ...
  () => {
    ...
    it(
      "requires callAmount for a call decision",
      () => {
        const heroCards: Card[] = [
          {
            rank: "A",
    ...
    it(
      "requires betAmount for a bet decision",
      () => {
        const heroCards: Card[] = [
          {
            rank: "A",
    ...
    it(
      "requires foldProbability for a bet decision",
      () => {
        const heroCards: Card[] = [
          {
            rank: "A",
    ...
    it(
      "requires raiseAmount for a raise decision",
      () => {
        const heroCards: Card[] = [
          {
            rank: "A",
    ...
    it(
      "requires opponentCallAmount for a raise decision",
      () => {
        const heroCards: Card[] = [
          {
            rank: "A",
    ...
    it(
      "requires foldProbability for a raise decision",
      () => {
        const heroCards: Card[] = [
          {
            rank: "A",
